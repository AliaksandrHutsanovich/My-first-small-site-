...
class Razmetka9 extends React.Component {
                       
                       
                       constructor(props) {
                         super(props);
                         this.state = {motos: (this.props.motos || [])};  
                       ...
                       press(){
                            class Razmetka8 extends React.Component {
                                render() {
                                     return (
                                          <form action="/motoPage" encType='multipart/form-data' method="post">
                       ...
                       render() {
                           ...
                           var motos = this.state.motos.map(function(moto) {
                                 return <Moto _id={moto._id} title={moto.text1} photo={moto.file} year={moto.text2} userName={moto.text3} phoneNum={moto.text4} dateAdd={moto.time}></Moto>;
                                 });
